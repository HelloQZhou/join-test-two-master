        ...
        <div>
          <span class="profile-picture">
            <img
              ...
              src="/static/image/teachers/header2.jpeg"
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      _this.$ajax.post(url, _this.teacher).then((response) => {
        Loading.hide();
    ...
    del(id) {
      ...
      Confirm.show("删除后不可恢复,请三思而后行", function () {
        ...
        _this.$ajax.delete(url + id).then((response) => {
          Loading.hide();
    ...
    afterUpload(data) {
      let _this = this;
      _this.teacher.image = data.content.shard;
      _this.$forceUpdate();
